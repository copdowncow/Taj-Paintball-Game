...
interface Booking { id:string; booking_number:string; customer_name:string; customer_phone:string; customer_email?:string; game_date:string; game_time:string; players_count:number; balls_count:number; total_price:number; prepayment_amount:number; booking_status:string; prepayment_status:string; customer_comment?:string; admin_comment?:string; created_at:string; logs?:Log[]; }
